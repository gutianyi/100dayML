...
import coverage
import covlib
import Bubble_Sort_1b as bs_1b
import Mid_1b_v1 as mid_1b
...
def coverage_generate(tested_program_path, tested_program_name, test_case_path, test_case_result_path):
    ...
    statement_num_sum = covlib.get_codelines(tested_program_path)    # -1是因为merge sort有一句else不属于executable statement
